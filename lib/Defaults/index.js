...
const version = [2, 3000, 1040656236];
...
export const DONATE_URL = 'https://saweria.co/felice'; // Lia@Note 02-02-26 --- Apologies if this feels cheeky, just a fallback
export const LIBRARY_NAME = 'olivea777/baileys';
